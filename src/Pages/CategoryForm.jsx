...
const CategoryForm = () => {
    ...
    return (
        <div className="d_MP-container w-full mt-10 p-8 bg-white rounded-2xl shadow-2xl border border-[#254D70]/10">
            <h2 className="d_MP-title text-3xl font-extrabold mb-8 text-center tracking-wide">Add New Category</h2>
            <form onSubmit={handleSubmit} className="space-y-8">
                <div className="mb-6">
                    <h3 className="d_MP-section-title text-xl font-bold mb-4">Category Images</h3>
                    <div
                ...
                <div className="mb-6">
                    <h3 className="d_MP-section-title text-xl font-bold mb-4">Category Information</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label className="d_MP-label block mb-2 font-semibold">Category Name</label>
                            <input
                                type="text"
                                name="categoryName"
